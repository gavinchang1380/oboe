...
public class TapToToneColdActivity extends TestOutputActivityBase {
    ...
    protected void inflateActivity() {
        setContentView(R.layout.activity_tap_to_tone_cold);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getPackageManager().hasSystemFeature(PackageManager.FEATURE_MIDI)) {
            ...
            Toast.makeText(TapToToneColdActivity.this,
